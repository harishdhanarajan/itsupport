...
st.markdown("<h1 style='text-align: center; background-color: #05007C; color: #FFFFFF'>Welcome to IT Support</h1>", unsafe_allow_html = True)
st.markdown("<h4 style='text-align: center; background-color: #05007C; color: #FFFFFF'>Access and Technology Hub for BNYM</h4>", unsafe_allow_html = True)
